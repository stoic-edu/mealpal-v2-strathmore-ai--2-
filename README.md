...
A web-first cafeteria ordering app for Strathmore University with a mobile-featured interface in development. Order ahead, pay with M-Pesa, and skip the queue.
